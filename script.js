const langData = {
    en: { f: 'gb', n: 'ENGLISH', q_whiskey: "«Every joke has a grain of whiskey»", btn_get_id: "GET ID TOKEN", btn_to_hall: "PROCEED", btn_save: "SAVE", btn_enter: "ENTER BAR", label_avatar: "AVATAR" },
    ...
    br: { f: 'br', n: 'PORTUGUÊS', q_whiskey: "«Toda piada tem um poco de uísque»", btn_get_id: "OBTER ID", btn_to_hall: "AO SALÃO", btn_save: "SALVAR", btn_enter: "ENTRAR", label_avatar: "AVATAR" }
};
...
function updateQR(containerId, text) {
    ...
    box.innerHTML = "";
    if(window.QRCode) new QRCode(box, { text: text, width: 80, height: 80 });
}
